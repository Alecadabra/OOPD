...
// Utitity submodules
        ...
        while( ( num <= 17 && num >= 10 ) || ( num <= 27 && num >= 20 ) )
        {
            ...
            catch( IllegalArgumentException e )
            {
                printErr( "Error with " + e.getMessage() );
                    ...
                    //messages that make sense when added to this message a
            }
        }//End while loop
    ...
    ************************************************/
    public char loadShips()
    {
        ...
        String message = new String(); //Final message assigned by file.load
        ...
        {
            //If file.load returns an error
            printErr( message );
        }
        else
        {
            //If file.load is successful
            print( message );
        }
        printLine();
    ...
    ************************************/
    public char viewShips()
    {
        ...
        {   // If there are no ships in storage
            print( "No ships in storage. You have " + Ships.getSlots() + 
                " ship slots left" );
        }
        else
        {   // If there were ships in storage
            print( "You have " + Ships.getSlots() + " ship slots left." );
        }
        printLine();
    ...
    ************************************************/
    public char duplicates()
    {
        ...
        else
        {
            ...
            while( ( dupeArr[i] != null ) && ( i < dupeArr.length ) )
            {
                printLine();
